    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
      ...
      .OnDelete(DeleteBehavior.Restrict);  
        ...
        modelBuilder.Entity<Recept>().HasData(
            ...
            new Recept { ReceptId = 4, Naziv = "Tiramisu", OpisRecepta = "Ukusan talijanski desert sa slojevima kvasca, kave, kisele pavlake i kakaa.", OpisPripreme = "Pomiješati mascarpone s jajima, dodati kavu i složiti u slojeve s piškotama.", VrijemePripreme = 40, KorisnikId = 3, DatumObjave = DateTime.Now, Premium = true, VrstaJelaId = 9, KategorijaId = 3, Status = true, Slika = Convert.FromBase64String(Images.Slike[0]) },
