...
final TextEditingController dateofPublicationController = TextEditingController();
  ...
  @override
   void didChangeDependencies(){
    ...
    void initState(){
      ...
      preparationTimeController.text = ("${_recept?.vrijemePripreme?.toString()}min");
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: <Widget>[
                ...
                _buildDetailRow(
                  'Vrsta jela',
                  vrstaJelaResult?.result.firstWhere(
                        (item) => item.vrstaJelaId == _recept?.vrstaJelaId,
                      ).naziv ?? 'Nepoznato',
                  valueStyle: const TextStyle(
                    fontSize: 18,
                    fontWeight: FontWeight.bold,
                ...
                _buildDetailRow(
                  'Kategorija',
                  kategorijaResult?.result.firstWhere(
                        (item) => item.kategorijaId == _recept?.kategorijaId,
                      ).naziv ?? 'Nepoznato',
                  valueStyle: const TextStyle(
                    fontSize: 18,
                    fontWeight: FontWeight.bold,
