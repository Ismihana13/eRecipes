...
class _RecipeListScreenState extends State<RecipeListScreen> {
  ...
  void initState() {
    ...
    // Provera da li su provider-i pravilno inicijalizovani
    if (_recipeProvider == null || _likeProvider == null) {
      print('Provider nije inicijalizovan!');
    } else {
      loadData();
    }
  }
  ...
  List<Widget> _buildRecipeCardList() {
    // Provera da li su podaci null ili prazni
